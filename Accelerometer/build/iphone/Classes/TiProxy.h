...
//Rare exceptions to indicate a bug in the _accelerometer code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Accelerometer proxies.
 */
