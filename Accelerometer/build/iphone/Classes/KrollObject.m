...
//@interface AccelerometerObject : NSObject
//@end

@interface AccelerometerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AccelerometerObject class]])
		{
			for (NSString *key in [[(AccelerometerObject*)o modules] allKeys])
			{
