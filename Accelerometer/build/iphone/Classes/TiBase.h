...
// in simulator we redefine to format for Accelerometer Developer console
...
{\
	NSString * exceptionName = [@"org.accelerometer." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.accelerometer";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAccelerometerNativeItemNone = -1, 
	UIAccelerometerNativeItemSpinner = -2,
	UIAccelerometerNativeItemProgressBar = -3,
	
	UIAccelerometerNativeItemSlider = -4,
	UIAccelerometerNativeItemSwitch = -5,
	UIAccelerometerNativeItemMultiButton = -6,
	UIAccelerometerNativeItemSegmented = -7,
	
	UIAccelerometerNativeItemTextView = -8,
	UIAccelerometerNativeItemTextField = -9,
	UIAccelerometerNativeItemSearchBar = -10,
	
	UIAccelerometerNativeItemPicker = -11,
	UIAccelerometerNativeItemDatePicker = -12,
	
	UIAccelerometerNativeItemInfoLight = -13,
	UIAccelerometerNativeItemInfoDark = -14,
	
	UIAccelerometerNativeItemDisclosure = -15,
	
	UIAccelerometerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Accelerometer instances of
