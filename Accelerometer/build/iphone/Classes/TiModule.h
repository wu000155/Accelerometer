...
/**
 The base class for all Accelerometer modules
 */
...
/**
 Accelerometer Platform calls this method on startup.
 */
-(void)startup;

/**
 Accelerometer Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Accelerometer Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Accelerometer Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Accelerometer Platform calls this method on resume.
 @param sender The sender of the event.
 */
