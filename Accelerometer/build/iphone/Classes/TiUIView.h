...
/**
 Base class for all Accelerometer views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Accelerometer view hierarchy (such as wrapped iOS UIViews) was touched.
