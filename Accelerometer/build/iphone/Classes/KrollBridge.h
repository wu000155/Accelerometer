...
@interface AccelerometerObject : KrollCoverageObject {
#else
@interface AccelerometerObject : KrollObject {
#endif
@private
...
extern NSString * Accelerometer$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AccelerometerObject *_accelerometer;
    KrollObject* console;
	BOOL shutdown;
